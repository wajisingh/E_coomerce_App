...
class Wishlist extends StatelessWidget {
  ...
  Widget _buildTitle(String title) {
    return Align(
      ...
      child: Text(title, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 18)),
    );
  }
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(product['price'], style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
